...
@interface MoGoRoomBusiness5 ()<MoGoRoomBaseAPIManagerCallBackDelegate,MGBusinessProtocol>
...
@implementation MoGoRoomBusiness5
...
- (void)managerCallAPIDidSuccess:(MoGoRoomAPI *)manager
{
    ...
    self.completionHandler ? self.completionHandler(4) : nil;
}
