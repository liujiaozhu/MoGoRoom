...
@interface MoGoRoomBusiness3 ()<MoGoRoomBaseAPIManagerCallBackDelegate,MGBusinessProtocol>
...
@implementation MoGoRoomBusiness3
...
- (void)managerCallAPIDidSuccess:(MoGoRoomAPI *)manager
{
    ...
    self.completionHandler ? self.completionHandler(2) : nil;
}
